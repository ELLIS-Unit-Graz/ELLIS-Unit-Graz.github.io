...
The **ELLIS Unit Graz** advances foundational machine learning research in the fields of Brain-inspired ML, Resource-efficient Deep Learning, Human-centred Computing, Trustworthy AI, Visual Computing, and Probabilistic ML. 

Our **mission** is to develop an in-depth understanding of the contemporary ML systems, and to create methods that are principled, efficient, and practically applicable across domains. In our unit we focus on talent development, foster interdisciplinary collaboration with other scientific disciplines and keep strong connections to industry.
